...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/sneakerseekers/event/{id}").permitAll()
                .antMatchers(HttpMethod.POST, "/sneakerseekers/event").hasAnyAuthority("ADMIN")
                .antMatchers(HttpMethod.GET, "/sneakerseekers/favorite").hasAnyAuthority("USER", "VENDOR", "ADMIN")
                .antMatchers(HttpMethod.GET, "/sneakerseekers/favorite/{externalStyleId}").hasAnyAuthority("USER", "VENDOR", "ADMIN")
                ...
                .antMatchers(HttpMethod.DELETE, "/sneakerseekers/favorite").hasAnyAuthority("USER", "VENDOR", "ADMIN")
                .antMatchers(HttpMethod.GET, "/sneakerseekers/follow").hasAnyAuthority("USER", "VENDOR", "ADMIN")
                .antMatchers(HttpMethod.GET, "/sneakerseekers/follow/{vendorId}").hasAnyAuthority("USER", "VENDOR", "ADMIN")
                ...
                .antMatchers(HttpMethod.POST, "/sneakerseekers/listing").hasAnyAuthority( "VENDOR")
                .antMatchers(HttpMethod.DELETE, "/sneakerseekers/listing/{id}").hasAnyAuthority("VENDOR", "ADMIN")
                .antMatchers(HttpMethod.GET, "/sneakerseekers/location").permitAll()
                ...
                .antMatchers(HttpMethod.GET, "/sneakerseekers/table").hasAnyAuthority("VENDOR")
